...
const WORK_IDS = Object.keys(WORKS);
...
const seasonOf = (turn) => SEASONS[(turn - 1) % 4];
const yearOf = (turn) => Math.floor((turn - 1) / 4) + 1;
...
function lordOf(natId) { return WARLORDS[natId]; }
...
const LEADERLESS = { mul: { food: 0.85, scrap: 0.85, men: 0.8 }, upkeep: 1.12,
